...
<div style="height: 4%">
	<form name="searchform" method="post" id ="searchform">
		菜单名称：<input type="text" name="qname" class="easyui-textbox">
...
<div id="dd" class="easyui-dialog" style="width: 400px;text-align: center;padding: 10px;" closed="true">
	<form id="ff" method="post">
		<table style="margin: 0 auto;">
			...
			<tr>
				<td class="right">菜单节点编号：</td>
				<td><input type="text" name="code" class="easyui-textbox" data-options="required:true"></td>
			</tr>
			<tr>
				<td class="right">菜单节点编号：</td>
				<td><input type="text" name="pcode" class="easyui-textbox" data-options="required:true"></td>
			</tr>
			<tr>
				<td class="right">菜单链接地址：</td>
				<td><input type="text" name="url" class="easyui-textbox" data-options="required:true"></td>
			</tr>
			<tr>
				<td class="right">菜单状态：</td>
				<td>
