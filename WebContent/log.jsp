...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			idField:"id",
			url:"LogServlet?opType=queryByPage",
			...
			columns:[[
				...
				{field:"loginTime",title:"登入时间",width:100,align:"center"},
				{field:"logoutTime",title:"登出时间",width:100,align:"center"},
			]],
			fitColumns:true,
			toolbar: [{
				text:"新增",
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "LogServlet?opType=update&id="+array[0].id;
		//表单填充内容
...
<body>
	<div style="height: 5%">
		<form name="searchform" method="post" id ="searchform">
			...
			员工编号：<input type="text" name="qempId" class="easyui-textbox">
