...
<script type="text/javascript">
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "roleMenu/update?id="+array[0].id;
		//表单填充内容
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				<tr>
					...
					<td>
						<select id="de" name="name">  
						</select>
					</td>
				</tr>
				<tr>
					<td class="right">菜单编号：</td>
					<td><input type="text" name="mname" class="easyui-textbox" data-options="required:true"></td>
				</tr>
